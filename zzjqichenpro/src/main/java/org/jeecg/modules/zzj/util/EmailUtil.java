...
public class EmailUtil {
   /* static String HOST = "smtp.163.com"; // smtp服务器
    static String FROM = "18749195329@163.com"; // 发件人地址
    static String TO = "149331731@qq.com"; // 收件人地址
    static String AFFIX = "D:\\PDFBill.pdf"; // 附件地址  为本地地址
    static String AFFIXNAME = "pdf.pdf"; // 附件名称
    static String USER = "18749195329@163.com"; // 用户名
    static String PWD = "hejiahua182018"; // 163的授权码
    static String SUBJECT = "消费明细"; // 邮件标题
...
/**/
     ...
     * 发送邮件
     */
    public static void send(String context, String HOST, String FROM, String AFFIX,
                            String AFFIXNAME, String USER, String PWD, String SUBJECT, String[] TOS) {
